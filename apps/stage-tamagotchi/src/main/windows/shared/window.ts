...
import { createAppService, createDesktopControlService, createPowerMonitorService, createScreenService, createSystemPreferencesService, createWindowService } from '../../services/electron'
...
export async function setupBaseWindowElectronInvokes(params: {
  ...
  createDesktopControlService({ context: params.context })
